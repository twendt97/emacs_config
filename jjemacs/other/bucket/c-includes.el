...
;; * Emulate more features of the preprocessor, in order to make
;;   the output more realistic.

;;; Code:

(defconst c-includes-version "1.3"
  "This version of c-includes.")
  
;;; User Variables:

(defcustom c-includes-path
;;  '("d:\devstudio\vc\include""d:\devstudio\vc\atl\include" "d:\devstudio\vc\mfc\include")
  '("./" "../" "../include")
